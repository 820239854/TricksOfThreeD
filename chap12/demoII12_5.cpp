...
char *object_filenames[NUM_OBJECTS] = {
	...
	const_cast<char *>("cube_flat_textured_01.cob"),
	const_cast<char *>("cube_flat_textured_02.cob"),
	const_cast<char *>("cube_gouraud_textured_01.cob"),
	const_cast<char *>("cube_gouraud_01.cob"),
	const_cast<char *>("sphere02.cob"),
	const_cast<char *>("sphere03.cob"),
};
...
int Game_Init(void *parms)
{
	...
	for (int index_obj = 0; index_obj < NUM_OBJECTS; index_obj++)
	{
		Load_OBJECT4DV2_COB2(&obj_array[index_obj], object_filenames[index_obj],
							 &vscale, &vpos, &vrot, VERTEX_FLAGS_SWAP_YZ | VERTEX_FLAGS_TRANSFORM_LOCAL
...
int Game_Main(void *parms)
{
	...
	static char *z_buffer_modes[3] = {
		const_cast<char *>("Z Buffering"),
		const_cast<char *>("1/Z Buffering"),
		const_cast<char *>("NO buffering"),
	};
	...
	Clip_Polys_RENDERLIST4DV2(&rend_list, &cam, ((x_clip_mode == 1) ? CLIP_POLY_X_PLANE : 0) | ((y_clip_mode == 1) ? CLIP_POLY_Y_PLANE : 0) | ((z_clip_mode == 1) ? CLIP_POLY_Z_PLANE : 0));
