...
char* object_filenames[NUM_OBJECTS] = {
	const_cast<char*>("sphere_bw01.cob"),
	const_cast<char*>("cube_constant_textured_01.cob"),
	const_cast<char*>("cube_constant_textured_02.cob"),
	const_cast<char*>("fire_constant_cube01.cob"),
	const_cast<char*>("borg_cube_constant01.cob"),
	const_cast<char*>("sphere_constant_textured_02.cob"),
...
int Game_Main(void* parms)
{
	...
	if (pass_mode >= 1)
	{
		...
		else if (wireframe_mode == 1)
		{
			...
			// set up rendering context
			rc.attr = RENDER_ATTR_NOBUFFER | RENDER_ATTR_ALPHA
				//| RENDER_ATTR_MIPMAP
				//| RENDER_ATTR_BILERP
				| RENDER_ATTR_TEXTURE_PERSPECTIVE_AFFINE;
