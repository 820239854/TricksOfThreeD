...
char* object_constant_filenames[NUM_OBJECTS] = {
	...
	const_cast<char*>("rec_constant_textured_01.cob"),
};

// filenames of objects to load
char* object_flat_filenames[NUM_OBJECTS] = {
	const_cast<char*>("cube_flat_textured_02.cob"),
	const_cast<char*>("sphere_flat_textured_02.cob"),
	const_cast<char*>("rec_flat_textured_01.cob"),
};

// filenames of objects to load
char* object_gouraud_filenames[NUM_OBJECTS] = {
	const_cast<char*>("cube_gouraud_textured_02.cob"),
	const_cast<char*>("sphere_gouraud_textured_02.cob"),
	const_cast<char*>("rec_gouraud_textured_01.cob"),
};
