	...
	LPARAM lparam)
{
	...
	case WM_COMMAND:
	{
		...
		case ID_FILE_LOAD_LEV:
		{
			...
			if (DialogBoxA(main_instance, MAKEINTRESOURCE(IDD_DIALOG1), hwnd, DialogProc) == IDOK)
			{
		...
		case ID_FILE_SAVE_LEV:
		{
			...
			if (DialogBoxA(main_instance, MAKEINTRESOURCE(IDD_DIALOG2), hwnd, DialogProc) == IDOK)
			{
