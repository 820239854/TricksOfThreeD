...
void QUAT_Print(QUAT_PTR q, char* name = const_cast <char*>("q"))
{
...
void VECTOR2D_Print(VECTOR2D_PTR va, char* name = const_cast <char*>("v"))
{
...
void VECTOR3D_Print(VECTOR3D_PTR va, char* name = const_cast <char*>("v"))
{
...
void VECTOR4D_Print(VECTOR4D_PTR va, char* name = const_cast <char*>("v"))
{
...
void Print_Mat_2X2(MATRIX2X2_PTR ma, char* name = const_cast <char*>("M"))
{
...
void Print_Mat_3X3(MATRIX3X3_PTR ma, char* name = const_cast <char*>("M"))
{
	// prints out a 3x3 matrix
	Write_Error("\n%s=\n", name);
...
void Print_Mat_4X4(MATRIX4X4_PTR ma, char* name = const_cast <char*>("M"))
{
