...
char* opcode_names[] = { const_cast<char*>("OPC_E"),
						const_cast<char*>("OPC_NE"),
						const_cast<char*>("OPC_N"),
						const_cast<char*>("OPC_NW"),
						const_cast<char*>("OPC_W"),
						const_cast<char*>("OPC_SW"),
						const_cast<char*>("OPC_S"),
						const_cast<char*>("OPC_SE"),
						const_cast<char*>("OPC_STOP"),
						const_cast<char*>("OPC_RAND"),
						const_cast<char*>("OPC_END"), };
// sound stuff
...
// set the animation to right direction
	...
	engines_id = DSound_Load_WAV(const_cast <char*>("ENGINES.WAV"));
