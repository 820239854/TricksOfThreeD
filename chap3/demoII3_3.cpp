...
int Game_Init(void *parms = NULL)
{
    ...
    sound_ids[0] = DSound_Load_WAV(const_cast<char *>("DEACTIVATE1.WAV"));
    sound_ids[1] = DSound_Load_WAV(const_cast<char *>("EXP0.WAV"));
    sound_ids[2] = DSound_Load_WAV(const_cast<char *>("INCORRECT1.WAV"));
    sound_ids[3] = DSound_Load_WAV(const_cast<char *>("UPLINK1.WAV"));
