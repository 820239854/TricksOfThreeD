...
char* object_filenames[NUM_OBJECTS] = {
	const_cast<char*>("earth01.cob"),
	const_cast<char*>("sphere_gouraud_textured_02.cob"),
	const_cast<char*>("fire_constant_cube01.cob"),
};
...
char* object_light_filenames[NUM_LIGHT_OBJECTS] = {
	const_cast<char*>("cube_constant_red_01.cob"),
	const_cast<char*>("cube_constant_green_01.cob"),
	const_cast<char*>("cube_constant_blue_01.cob"),
	const_cast<char*>("cube_constant_yellow_01.cob"),
	const_cast<char*>("cube_constant_white_01.cob"),
};
...
int Game_Init(void* parms)
{
	...
	Generate_Terrain_OBJECT4DV2(&obj_terrain,                // pointer to object
		...
		| POLY4DV2_ATTR_SHADE_MODE_GOURAUD | POLY4DV2_ATTR_SHADE_MODE_TEXTURE);
	...
	for (int index_obj = 0; index_obj < NUM_OBJECTS; index_obj++)
	{
		Load_OBJECT4DV2_COB2(&obj_array[index_obj], object_filenames[index_obj],
			&vscale, &vpos, &vrot, VERTEX_FLAGS_INVERT_WINDING_ORDER | VERTEX_FLAGS_TRANSFORM_LOCAL | VERTEX_FLAGS_TRANSFORM_LOCAL_WORLD, 0);
	...
	Load_OBJECT4DV2_COB2(&shadow_obj, "shadow_poly_01.cob",
		&vscale, &vpos, &vrot, VERTEX_FLAGS_INVERT_WINDING_ORDER | VERTEX_FLAGS_SWAP_YZ | VERTEX_FLAGS_TRANSFORM_LOCAL | VERTEX_FLAGS_TRANSFORM_LOCAL_WORLD, 0);
	// set up lights
