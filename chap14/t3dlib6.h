...
int StripChars(const char* string_in, char* string_out, const char* strip_chars, int case_on = 1);
...
int Load_OBJECT4DV1_3DSASC(OBJECT4DV1_PTR obj, const char* filename, VECTOR4D_PTR scale, VECTOR4D_PTR pos, VECTOR4D_PTR rot, int vertex_flags = 0);
