...
int Draw_Text_GDI(const char* text, int x, int y, COLORREF color, LPDIRECTDRAWSURFACE7 lpdds)
{
...
int Draw_Text_GDI(const char* text, int x, int y, int color, LPDIRECTDRAWSURFACE7 lpdds)
{
	// this function draws the sent text on the sent surface 
	// using color index as the color in the palette
